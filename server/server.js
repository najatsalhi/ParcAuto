...
// Insert a new repair for an article
...
// Insert a new report for an article
...
app.post("/layout/Personnel", (req, res) => {
    const sql = "INSERT INTO chauffeur (id_chauffeur, nom, prenom, telephone, email, permie, date_debut, date_fin, id_vehicule) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    const values = [
        null, // Assuming id_chauffeur is auto-incremented
        req.body.nom,
        req.body.prenom,
        req.body.telephone,
        req.body.email,
